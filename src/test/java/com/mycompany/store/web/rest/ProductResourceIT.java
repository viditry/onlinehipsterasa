...
class ProductResourceIT {
    ...
    private static final SizeCloth DEFAULT_SIZE_CLOTH = SizeCloth.S;
    private static final SizeCloth UPDATED_SIZE_CLOTH = SizeCloth.M;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getSizeCloth()).isEqualTo(DEFAULT_SIZE_CLOTH);
    ...
    @Test
    @Transactional
    void checkSizeClothIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setSizeCloth(null);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].sizeCloth").value(hasItem(DEFAULT_SIZE_CLOTH.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.sizeCloth").value(DEFAULT_SIZE_CLOTH.toString()))
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getSizeCloth()).isEqualTo(UPDATED_SIZE_CLOTH);
