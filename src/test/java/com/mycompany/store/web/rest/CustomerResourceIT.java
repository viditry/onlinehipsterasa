...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_ADRESS_LINE_1 = "AAAAAAAAAA";
    private static final String UPDATED_ADRESS_LINE_1 = "BBBBBBBBBB";

    private static final String DEFAULT_ADRESS_LINE_2 = "AAAAAAAAAA";
    private static final String UPDATED_ADRESS_LINE_2 = "BBBBBBBBBB";
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAdressLine1()).isEqualTo(DEFAULT_ADRESS_LINE_1);
        assertThat(testCustomer.getAdressLine2()).isEqualTo(DEFAULT_ADRESS_LINE_2);
    ...
    @Test
    @Transactional
    void checkAdressLine1IsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setAdressLine1(null);
    ...
    void putNewCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAdressLine1()).isEqualTo(UPDATED_ADRESS_LINE_1);
        assertThat(testCustomer.getAdressLine2()).isEqualTo(UPDATED_ADRESS_LINE_2);
